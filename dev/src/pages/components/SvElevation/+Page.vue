...
import { SvElevation } from '$lib/index';
</script>
...
.test
  ...
  &-elevation
    &--0
      --sv-elevation-level: 0

      &:hover
        --sv-elevation-level: 1

    &--1
      --sv-elevation-level: 1

      &:hover
        --sv-elevation-level: 2

    &--2
      --sv-elevation-level: 2

      &:hover
        --sv-elevation-level: 3
    ...
    &--4
      --sv-elevation-level: 4

      &:hover
        --sv-elevation-level: 5
