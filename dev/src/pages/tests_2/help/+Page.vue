...
import HelpStep from '$dev/components/HelpStep.vue';
</script>

<template>
  <p style="color: hsl(0, 0%, 50%);">
    There are a lot of approaches to rendering pages for sites or web apps. The best mode for you will depend entirely on your project. That being said, here are some <i>general recommendations</i> if you are just starting out with your project.
  </p>

  <p style="color: hsl(0, 0%, 50%);">
    <i>This page is most useful after you are familiar with the modes above.</i>
  </p>
